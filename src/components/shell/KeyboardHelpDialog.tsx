...
const SHORTCUTS: { keys: string; action: string }[] = [
  ...
  { keys: 'Alt+1 .. 4', action: 'Tabs: Workflow / Settings / Runs / Environment' },
  { keys: 'Ctrl/Cmd+B', action: 'Toggle right panel (Build / Inspector)' },
  { keys: 'Ctrl/Cmd+I', action: 'Toggle right panel (Build / Inspector)' },
  { keys: 'Ctrl/Cmd+J', action: 'Toggle Bottom Dock' },
  { keys: 'Ctrl/Cmd+S', action: 'Save' },
  { keys: 'Ctrl/Cmd+Z', action: 'Undo (graph)' },
  { keys: 'Ctrl/Cmd+Shift+Z', action: 'Redo (graph)' },
  ...
  { keys: 'Arrow keys', action: 'Tab nav; library item nav; canvas nudge (Shift = 10px)' },
